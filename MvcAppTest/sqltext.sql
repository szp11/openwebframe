...
create table logmsginfo(msgid bigint not null,msgmark varchar(64) not null, msgtype varchar(32) not null,logmsg varchar(128) not null,msgowner varchar(32) not null,msgtime datetime not null, primary key(msgid));
