...
create table loginfo (logid varchar(64) not null, typeid varchar(32) not null,logmsg varchar(128) not null,logowner varchar(32) not null,logtime datetime not null, primary key(logid));
