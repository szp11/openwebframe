...
{
    /// <summary>
    /// 继承了对象容器类，用来缓存对象。继承ILogDB_WuQi接口，来实现主库
    /// </summary>
    internal class CLogContainer_WuQi : ObjectContainer_WuQi<SLogRecord_WuQi>, ILogDB_WuQi
    {
        private string str_conn = null;
        public CLogContainer_WuQi(string conn,ICacheStorage_WuQi ics,ICacheDependency_WuQi icd)
            : base(ics,icd)
        {
            this.str_conn = conn;
        }
